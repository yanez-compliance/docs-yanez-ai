...
See [Errors](yid/api/errors.md) for the full status code reference.
...
1. Generate a new Ed25519 key pair on the partner backend. See
   [Onboarding](yid/onboarding.md#key-generation).
...
[launch gate](yid/onboarding.md#launch-gates).
...
| Production | `https://yid.yanez.ai` | Live traffic only, after the [production checklist](yid/production-checklist.md). |
...
The [quickstart troubleshooting table](yid/quickstart.md#5-troubleshoot-a-401) maps
...
[documentation repository](https://github.com/yanez-compliance/docs-yanez-ai)
